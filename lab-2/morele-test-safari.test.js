...
describe('Morele', () => {
    ...
    test('Should add recommended product in cart', async () => {
        ...
        expect(await addToCartButton.getText()).toContain('Do koszyka');
        ...
        expect(await driver.findElement(By.css('.product-title > a')).getText()).toContain(productName);
        expect(await driver.findElement(By.className('subtotal-price')).getText()).toContain("799 zł");
